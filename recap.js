...
// insert many records inside the collection ?
...
db.instructors.find().constructor.name /// result from this query ---> DBQuery
...
// mongos knows that you need to work the returned result -->
// shortcut --> .forEachh with DBQuery 
...
// get instructors  _id > 8 
//     db.instructors.find().filter

db.instructors.find().toArray().filter((document) => (document._id > 8))
